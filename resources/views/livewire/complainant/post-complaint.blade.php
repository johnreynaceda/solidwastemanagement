<div x-data="mapComponent(@js($allPuroks))" x-init="initMap()">
    ...
    <script>
        ...
        //                         })
        //                         .bindPopup(`<strong>${purok.name}</strong>`)
        //                         .addTo(this.map);
        ...
        //                 this.map.setView([selectedPurok.latitude, selectedPurok.longitude], 12);
        //             } else {
        ...
        //             if (selectedPurok && selectedPurok.latitude && selectedPurok.longitude) {
        //                 console.log(`Centering map on Purok: ${selectedPurok.name}`);
        //                 this.map.setView([selectedPurok.latitude, selectedPurok.longitude], 16);
        //             } else {
        //                 console.warn("Selected Purok has invalid coordinates.");
        //             }
        //         },
        ...
        //                     // Create a circle (radius in meters, e.g., 100 meters radius)
        //                     const circle = L.circle([purok.latitude, purok.longitude], {
        //                             color: '#a16207', // Circle color
        //                             fillColor: 'rgb(250 204 21 / 0.7)', // Fill color
        //                             fillOpacity: 0.5, // Fill opacity
        //                             radius: 100 // Radius in meters
        //                         })
        //                         .bindPopup(`<strong>${purok.name}</strong>`)
        ...
        //                     fillOpacity: 0.5, // Fill opacity
        //                     radius: 100 // Radius in meters
        //                 }).bindPopup(`<strong>${selectedPurok.name}</strong>`).addTo(this.map);
        ...
        //                     // Determine circle color based on complaints count
        //                     const circleColor = purok.complaints_count > 0 ? 'red' : 'yellow';
        ...
        //                 // Determine circle color based on complaints count
        //                 const circleColor = selectedPurok.complaints_count > 0 ? 'red' : 'yellow';
