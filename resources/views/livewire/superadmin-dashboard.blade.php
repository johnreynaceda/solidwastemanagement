    ...
    <div class="grid grid-cols-4 gap-5">
        <div class="border py-3 px-5 rounded-lg">
            <div class="flex justify-between items-center">
                <h1 class="text-lg font-semibold text-gray-700">Barangays</h1>
            ...
            <div class="mt-2">
                <p class="text-3xl font-semibold text-green-600">{{ \App\Models\Barangay::count() }}</p>
            </div>
        </div>
        <div class="border py-3 px-5 rounded-lg">
            <div class="flex justify-between items-center">
                <h1 class="text-lg font-semibold text-gray-700">Puroks</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-trending-up-down text-green-500">
                    <path d="M14.828 14.828 21 21" />
            ...
            <div class="mt-2">
                <p class="text-3xl font-semibold text-green-600">{{ \App\Models\Purok::count() }}</p>
            </div>
        </div>
        <div class="border py-3 px-5 rounded-lg">
            <div class="flex justify-between items-center">
                <h1 class="text-lg font-semibold text-gray-700">Wastes</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-trending-up-down text-green-500">
                    <path d="M14.828 14.828 21 21" />
            ...
            <div class="mt-2">
                <p class="text-3xl font-semibold text-green-600">{{ \App\Models\Waste::count() }}</p>
            </div>
        </div>
        <div class="border py-3 px-5 rounded-lg">
            <div class="flex justify-between items-center">
                <h1 class="text-lg font-semibold text-gray-700">Violations</h1>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-trending-up-down text-green-500">
                    <path d="M14.828 14.828 21 21" />
            ...
            <div class="mt-2">
                <p class="text-3xl font-semibold text-green-600">{{ \App\Models\Violation::count() }}</p>
            </div>
        </div>
    </div>
